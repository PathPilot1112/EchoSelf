  ...
  export default function ResultPage() {
    ...
    return (
      <div className="min-h-screen w-full font-grotesk" style={{ background: "#F5F0FF" }}>
        ...
        {/* NAV */}
        <nav className="w-full border-b-4 border-black bg-white flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3" style={{ height: "56px" }}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight" style={{ fontFamily: "Space Grotesk, sans-serif", color: "#0A0A0A" }}>
              {data.archetype}
            </h1>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start">
            ...
            <div
                ref={cardRef}
                className="w-full max-w-[360px] lg:max-w-[360px] lg:min-w-[360px]"
                style={{
                  background: "#0A0A0A",
                ...
                <div className="border-4 border-black p-4 bg-white" style={{ boxShadow: "4px 4px 0 #0A0A0A" }}>
                  ...
                  {data.archetypeScores.slice(0, 5).map((a, i) => (
                    <div key={a.name} className="flex items-center gap-3 mb-2 ">
                      <span className="w-24 sm:w-40" style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: "10px", color: i === 0 ? meta.color : "#888", flexShrink: 0, fontWeight: i === 0 ? 700 : 400 }}>
                        {a.name}
                      </span>
